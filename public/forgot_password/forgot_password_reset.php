...
if(isset($_GET['key']) && isset($_GET['email'])) {
    $key=$_GET['key'];
    $email=$_GET['email'];
    $check=mysqli_query($dbconnect,"SELECT * FROM password_reset WHERE email='$email' and temp_key='$key'");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if ($password2==$password1) {
            ...
            mysqli_query($dbconnect,"DELETE FROM forget_reset where email='$email' and temp_key='$key'");
