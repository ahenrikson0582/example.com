...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $email_reg=mysqli_real_escape_string($dbconnect,$_POST['email']);
    ...
    if (mysqli_num_rows($details)>0) { //if the given email is in database, ie. registered
        ...
        $sql_insert=mysqli_query($dbconnect,"INSERT INTO password_reset (email,temp_key) VALUES('$email_reg','$key')");
